# library-shipper
Library of processing functions for Magento 2 ShipperHQ client
...
Description
-----------
This library consists of classes used by the ShipperHQ Magento 2 extension to send and processing shipping rate requests.
It is not intended to be installed alone and therefore does not require standalone installation instructions. It is a dependency of shipperhq/module-shipper. 
